final List<String> classInstructions = [
  ...
  'Please Study Mode should be either "R = Regular","W=Weekend" ,or "E =Evening". Repeat the same for all classes with the same study mode',
...
final List<String> liberalInstructions = [
  'Please do not change the headings of the columns or the order of the columns',
  'Please do not change the sheet name or the order of the sheets',
  'Specify Yes or No for the Regular, Evening, and Weekend columns if the course is offered in the respective study mode',
