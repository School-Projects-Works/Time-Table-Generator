  ...
  Widget build(BuildContext context) {
    ...
    return dbProvider.when(
      error: ((error, stackTrace){
        return const Scaffold(body: Center(child: Text('Error connecting to database')));
      }),
      ...
      data: (data) {
        return fluent_ui.NavigationView(
            ...
            paneBodyBuilder: (item, child) {
              ...
              return dataFuture.when(
                  ...
                  loading: () => const Center(
                        child:
                            SizedBox(width: 50, height: 50, child: fluent_ui.ProgressRing()),
                      ),
                  error: (error, statck) {
            ...
            pane: fluent_ui.NavigationPane(
              size: const fluent_ui.NavigationPaneSize(compactWidth: 60, openWidth: 150),
