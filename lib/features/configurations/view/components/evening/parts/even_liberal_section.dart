...
class EveningLiberalSection extends ConsumerStatefulWidget {
  const EveningLiberalSection({super.key});

  @override
  ConsumerState<ConsumerStatefulWidget> createState() =>
      _EveningLiberalSectionState();
}

class _EveningLiberalSectionState extends ConsumerState<EveningLiberalSection> {
  @override
        ...
        child: SingleChildScrollView(
          child: Padding(
            ...
            child: Column(
                ...
                children: [
                  Text(
                    'Evening Leberal Courses'.toUpperCase(),
