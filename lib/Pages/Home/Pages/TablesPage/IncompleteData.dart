...
import '../CoursePage/SpecialVenueCoursesList.dart';
                    ...
                    child: Padding(
                      ...
                      child: Column(
                          ...
                          children: [
                            ...
                            const SizedBox(height: 20),
                            if (config.getConfigurations.days == null ||
                                config.getConfigurations.periods == null)
                              Row(
                                mainAxisAlignment:
                            ...
                            if (!config.getConfigurations.hasCourse)
                              Row(
                                mainAxisAlignment:
                                    MainAxisAlignment.spaceBetween,
                                children: [
                            ...
                            const SizedBox(height: 15),
                            if (!config.getConfigurations.hasClass)
                              Row(
                                mainAxisAlignment:
                                    MainAxisAlignment.spaceBetween,
                                children: [
                            ...
                            const SizedBox(height: 15),
                            if (!config.getConfigurations.hasVenues)
                              Row(
                                mainAxisAlignment:
                                    MainAxisAlignment.spaceBetween,
                                children: [
                            ...
                            const SizedBox(height: 15),
                            if (config.getConfigurations.hasLiberalCourse &&
                                (config.getConfigurations.liberalCourseDay ==
                                        null ||
