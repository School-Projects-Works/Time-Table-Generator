...
class ConfigurationModel {
  ...
  factory ConfigurationModel.fromMap(Map<String, dynamic> map) {
    return ConfigurationModel(
      ...
      days: map['days'] != null ? List<String>.from((map['days'] as List<String>)) : [],
      periods: map['periods'] != null ? List<Map<String, dynamic>>.from((map['periods'] as List<Map<String, dynamic>>).map<Map<String, dynamic>?>((x) => x,),) : [],
      liberalCourseDay: map['liberalCourseDay'] != null ? map['liberalCourseDay'] as String : null,
      liberalCoursePeriod: map['liberalCoursePeriod'] != null ? Map<String, dynamic>.from((map['liberalCoursePeriod'] as Map<String, dynamic>)) : null,
      hasLiberalCourse: map['hasLiberalCourse'] as bool,
      hasCourse: map['hasCourse'] as bool,
      hasClass: map['hasClass'] as bool,
      liberalLevel: map['liberalLevel'] != null ? map['liberalLevel'] as String : null,
      targetedStudents: map['targetedStudents'] != null ? map['targetedStudents'] as String : null,
      breakTime: map['breakTime'] != null ? List<Map<String, dynamic>>.from((map['breakTime'] as List<Map<String, dynamic>>).map<Map<String, dynamic>?>((x) => x,),) : null,
    );
  }

  String toJson() => json.encode(toMap());

  factory ConfigurationModel.fromJson(String source) => ConfigurationModel.fromMap(json.decode(source) as Map<String, dynamic>);
